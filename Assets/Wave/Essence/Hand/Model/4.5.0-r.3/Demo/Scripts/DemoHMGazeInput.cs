...
namespace Wave.Essence.Hand.Model.Demo
{
	...
	public sealed class DemoHMGazeInput : PointerInputModule
	{
		const string LOG_TAG = "Wave.Essence.Hand.Model.Demo.DemoHMGazeInput";
		...
		private DemoHMGazePointer gazePointer = null;
		...
		protected override void OnEnable()
		{
			if (!mEnabled)
			{
				...
				if (head != null)
				{
					gazePointer = head.GetComponentInChildren<DemoHMGazePointer>();
					if (gazePointer == null)
					{
						...
						gazePointer = pointer_object.AddComponent<DemoHMGazePointer>();
