...
namespace Wave.Essence.Interaction.Mode.Demo
{
	...
	public sealed class NaturalHandPointerTracker : MonoBehaviour
	{
		const string LOG_TAG = "Wave.Essence.Interaction.Mode.Demo.NaturalHandPointerTracker";
		...
		private NaturalHandSpotPointer m_HandSpotPointer = null;
		private bool ValidateParameters()
		{
			...
			if (new_pointer != null && !ReferenceEquals(pointerObject, new_pointer))
			{
				...
				m_HandSpotPointer = pointerObject.GetComponent<NaturalHandSpotPointer>();
			}
