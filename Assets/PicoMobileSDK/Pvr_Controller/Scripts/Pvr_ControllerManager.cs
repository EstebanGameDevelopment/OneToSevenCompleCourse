            ...
            if (controllerlink.controller0Connected)
            {
                ...
                if (!controllerlink.Controller0.isShowBoundary)
                {
                    ...
                    else
                    {
                        ...
                        Sensor.UPvr_SetReinPosition(sensorData[0], sensorData[1], sensorData[2], sensorData[3], sensorData[4], sensorData[5], sensorData[6], 0, true, Convert.ToInt32(("0" + Convert.ToString(keyData[15]) + "00"), 2));
                    }
                }
                else
                {
            ...
            if (controllerlink.controller1Connected)
            {
                ...
                if (!controllerlink.Controller1.isShowBoundary)
                {
                    ...
                    else
                    {
                        ...
                        Sensor.UPvr_SetReinPosition(sensorData[14], sensorData[15], sensorData[16], sensorData[17], sensorData[18], sensorData[19], sensorData[20], 1, true, Convert.ToInt32(("0" + Convert.ToString(keyData[82]) + "00"), 2));
                    }
                }
                else
                {
